...
public class SerwisDoKawy implements Serwis {
    ...
    public SerwisDoKawy(String numer, int iloscOsob, String nazwaWzoru, String czas, RodzajSerwisu rodzajSerwisu, List<Naczynie> naczynia) {
        this.numer = numer;
    ...
    public String toString(){
        return "com.company.Serwis: " + numer + "\nRodzaj Serwisu: " + "com.company.Serwis do kawy" + "\nTyp Serwisu: " + rodzajSerwisu;
    }
}
